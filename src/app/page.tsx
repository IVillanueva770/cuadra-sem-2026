  ...
  return (
    ...
    >
      <div className="w-full max-w-3xl flex flex-col items-center gap-9">
        ...
        {/* Card de acciones */}
        <section
          className="w-full max-w-md rounded-2xl p-6 flex flex-col gap-5 shadow-[var(--shadow-1)] transition-all duration-200 hover:-translate-y-1 hover:shadow-[var(--shadow-2)]"
          style={{
